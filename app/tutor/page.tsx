...
export default function TutorPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages([
        ...newMessages,
        { role: "ai", content: "Network error. Please check your connection and try again." },
      ]);
    } finally {
      setLoading(false);
    }
            ...
            {navItems.map((item) => (
              <button
                ...
                style={{
                  ...
                  color: item.id === "tutor" ? "#0a5e6d" : "rgba(255,255,255,0.7)",
                  textAlign: "left",
                  width: "100%",
          ...
          {messages.length === 0 && (
            <div style={{
              ...
              <div style={{
                ...
                Ask me anything about your SACE subjects — I'm here to help you understand, not just memorise.
              </div>
          ...
          {messages.map((msg, index) => (
            ...
            >
              ...
              <div style={{
                ...
                backgroundColor: msg.role === "user" ? "#0d7a8c" : "#ffffff",
                color: msg.role === "user" ? "#ffffff" : "#071e22",
                fontSize: 14,
                lineHeight: 1.6,
                border: msg.role === "ai" ? "1px solid #e0f0f3" : "none",
                whiteSpace: "pre-wrap",
              }}>
                {msg.content}
              </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 10,
              border: "none",
              backgroundColor: loading || !message.trim() ? "#b8d4d8" : "#0d7a8c",
              color: "#ffffff",
              fontSize: 14,
              fontWeight: 600,
