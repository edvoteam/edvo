...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (storedSubjects) {
      try { setSubjects(JSON.parse(storedSubjects)); } catch { setSubjects([]); }
    }
  }, []);
    ...
    <div style={{
            ...
            {navItems.map((item) => (
              <button
                ...
                style={{
                  ...
                  backgroundColor: activePage === item.id ? "#f5c518" : "transparent",
                  color: activePage === item.id ? "#005a73" : "rgba(255,255,255,0.7)",
                  textAlign: "left",
                  width: "100%",
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 16, fontWeight: 600, color: "#071e22" }}>Dashboard</div>
          ...
          <button
            ...
            style={{
              fontSize: 13, color: "#5a7a82", background: "none",
              border: "1px solid #d0e8f0", borderRadius: 8,
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "24px 28px" }}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                backgroundColor: "#f5c518", color: "#005a73",
          ...
          <div style={{
            ...
            {[
              ...
              <div key={stat.label} style={{
                ...
                padding: "18px 20px", border: "1px solid #d0e8f0",
              }}>
                <div style={{
                ...
                <div style={{ fontSize: 13, fontWeight: 600, color: "#071e22" }}>{stat.label}</div>
                <div style={{ fontSize: 11, color: "#5a7a82", marginTop: 2 }}>{stat.sub}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 20 }}>
            ...
            <div style={{
              backgroundColor: "#ffffff", borderRadius: 12,
              padding: "20px", border: "1px solid #d0e8f0",
            }}>
              <div style={{ fontSize: 14, fontWeight: 600, color: "#071e22", marginBottom: 14 }}>
                Your Subjects
              </div>
              {subjects.length === 0 ? (
                <div style={{ fontSize: 13, color: "#5a7a82" }}>No subjects added yet.</div>
              ) : (
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {subjects.map((subject, i) => (
                    <div key={subject}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
                        <span style={{ fontSize: 13, color: "#1a3a40" }}>{subject}</span>
                        <span style={{ fontSize: 11, color: "#5a7a82" }}>In progress</span>
                      </div>
                      <div style={{ height: 5, backgroundColor: "#f0f7f9", borderRadius: 3, overflow: "hidden" }}>
                        <div style={{
                          height: "100%", width: "10%",
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "1px solid #d0e8f0", backgroundColor: "#f0f7f9",
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontSize: 13, fontWeight: 600, color: "#071e22" }}>{action.label}</div>
                      <div style={{ fontSize: 11, color: "#5a7a82" }}>{action.sub}</div>
                    </div>
                    <span style={{ marginLeft: "auto", color: "#007090", fontSize: 16 }}>→</span>
                  </button>
                ))}
              </div>
            </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 13, color: "#5a7a82", textAlign: "center", padding: "20px 0" }}>
