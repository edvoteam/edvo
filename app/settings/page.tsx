            ...
            {navItems.map((item) => (
              <button
                ...
                style={{
                  ...
                  color: item.id === "settings" ? "#0a5e6d" : "rgba(255,255,255,0.7)",
                  textAlign: "left",
                  width: "100%",
            ...
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  ...
                  backgroundColor: activeTab === tab.id ? "#0d7a8c" : "transparent",
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div>
                  ...
                  <input
                    style={inputStyle}
                    placeholder="e.g. Glenunga International High School"
                    value={school}
                ...
                <div>
                  <label style={labelStyle}>
                    Target ATAR{" "}
                    <span style={{ color: "#5a7a82", fontWeight: 400 }}>(optional)</span>
                  </label>
                  <input
                    style={inputStyle}
                    placeholder="e.g. 90"
                ...
                {SUBJECTS.map((s) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 20,
                      border: "1.5px solid",
                      borderColor: subjects.includes(s) ? "#0d7a8c" : "#b8d4d8",
                      backgroundColor: subjects.includes(s) ? "#e0f5f8" : "#ffffff",
                      color: subjects.includes(s) ? "#0d7a8c" : "#5a7a82",
                      fontSize: 13,
